...
test.describe('Test add product with addons', () => {
    ...
    test('cPanel calculations', async () => {
        await test.step('1 Navigate to the cPanel store', async () => {
            await cPanelLicenses.open();
        });
        
        await test.step('2 Order a Product', async () => {
        ...
        await test.step('3 Enter IP Address', async () => {
        ...
        await test.step('4 Select Addons', async () => {
        ...
        await test.step('5 Continue to Review & Checkout', async () => {
        ...
        await test.step('6 Verify Product and Price', async () => {
        ...
        await test.step('7 Proceed to Checkout', async () => {
            await reviewCheckout.verifyCheckoutButtonVisible();
            await reviewCheckout.clickCheckoutButton();
        });

        await test.step('8 Verify Checkout Information', async () => {
